...
export const calculateFinalTotalWithDiscount = (selectedCoupon: Coupon | undefined  , selectedItem: SelectedProduct[]): number => {
...
export const discountText = (selectedCoupon: Coupon | null| undefined): string => {
